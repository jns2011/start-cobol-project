...
#define  COB_SOURCE_FILE		"E:\\msys64\\home\\PC\\COBOL\\calles\\atm.cbl"
#define  COB_PACKAGE_VERSION		"3.2"
#define  COB_PATCH_LEVEL		0
#define  COB_MODULE_FORMATTED_DATE	"Jun 30 2025 21:01:24"
#define  COB_MODULE_DATE		20250630
#define  COB_MODULE_TIME		210124
...
static int		COBOL__PROJECT ();
static int		COBOL__PROJECT_ (const int);
static void		COBOL__PROJECT_module_init (cob_module *module);
...
/* ENTRY 'COBOL__PROJECT' */

static int
COBOL__PROJECT ()
{
  return COBOL__PROJECT_ (0);
}

static int
COBOL__PROJECT_ (const int entry)
{
  ...
  /* Line: 8         : Entry     COBOL-PROJECT           : E:\msys64\home\PC\COBOL\calles\atm.cbl */
  l_2:;
#line 8 "E:\\msys64\\home\\PC\\COBOL\\calles\\atm.cbl"
  ENTRY_COBOL__PROJECT:	cob_nop ();
#line 105 "atm.c"

  /* Line: 8         : STOP RUN           : E:\msys64\home\PC\COBOL\calles\atm.cbl */
#line 8 "E:\\msys64\\home\\PC\\COBOL\\calles\\atm.cbl"
  cob_nop ();
#line 110 "atm.c"
  cob_stop_run (b_2);
  ...
  COBOL__PROJECT_module_init (module);
...
/* End PROGRAM-ID 'COBOL-PROJECT' */

/* Initialize module structure for COBOL-PROJECT */
static void COBOL__PROJECT_module_init (cob_module *module)
{
  module->module_name = "COBOL-PROJECT";
  ...
  module->module_entry.funcptr = (void *(*)())COBOL__PROJECT;
  module->module_cancel.funcptr = (void *(*)())COBOL__PROJECT_;
